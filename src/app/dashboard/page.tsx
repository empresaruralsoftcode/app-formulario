      ...
      {deleteConfirmId && (
        <div className={styles.modalOverlay} onClick={() => setDeleteConfirmId(null)}>
          <div className={styles.modal} onClick={e => e.stopPropagation()}>
            <h3 className={styles.modalTitle}>¿Eliminar entrevista?</h3>
            <p className={styles.modalBody}>
              Esta acción eliminará todos los datos de esta entrevista de forma permanente. No se puede deshacer.
            </p>
            <div className={styles.modalActions}>
              ...
              <button 
                ...
                onClick={() => deleteEntrevista(deleteConfirmId)}
                disabled={saving}
              >
